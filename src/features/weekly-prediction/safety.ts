...
export function weeklyPredictionTextIsSafe(values: string[]) {
  return values.every(textIsSafe);
}

export function weeklyMoneyTextIsSafe(value: string) {
  return categoryTextIsSafe(value, moneyForbiddenPatterns);
}

export function weeklyWellnessTextIsSafe(value: string) {
  return categoryTextIsSafe(value, wellnessForbiddenPatterns);
}
